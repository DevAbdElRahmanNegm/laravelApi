                                ...
                                <div class="tab-content">
                                    <div id="en" class="tab-pane fade in active">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title[]" class="form-control" id="title" aria-describedby="emailHelp" placeholder="Enter Categoty Title">
                                        </div>
                                        <div class="form-group">
                                            <label for="desc">description en</label>
                                            <textarea id="desc" name="descraption[]" class="form-control"></textarea>
                                        </div>
